    ...
    <div className="fr-container landing-main-container fr-my-8w">
      <div className="fr-grid-row fr-grid-row--center">
        <div className="fr-col-md-8">
          ...
          <p>
            Mon espace collectivité s’est assurée de la mise en œuvre par ses
          ...
          <p>
            La finalité du traitement de données réalisé par Mon espace
            collectivité est de faciliter la connaissance et l&apos;accès aux
            ...
            <table className="data-table" data-fr-js-table-element="true">
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    demande adressée à l’équipe Mon espace collectivité, en vue
